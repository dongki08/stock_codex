...
public class AdminSettingService { // 관리자 설정 서비스 클래스를 정의한다.
    ...
    public List<AdminSettingResponse> resetSettings() { // 기본 설정 값을 저장한다.
        List<AppSettingEntity> defaults = List.of( // 기본 설정 목록을 생성한다.
                ...
                new AppSettingEntity("recommendation.scoring.weights", "{\"value\":{\"liquidity\":0.20,\"price\":0.10,\"technical\":0.30,\"context\":0.15,\"fundamental\":0.10,\"dataQuality\":0.15},\"technical\":{\"ma\":0.30,\"rsi\":0.25,\"volume\":0.20,\"macd\":0.15,\"bollinger\":0.10},\"context\":{\"news\":0.40,\"disclosure\":0.18,\"macro\":0.25,\"fundamental\":0.17}}", "추천 feature 점수 가중치", "system"), // 추천 feature 점수 가중치 기본값을 정의한다.
                ...
                new AppSettingEntity("collection.news.tickersPerMarket", "{\"value\":20}", "시장별 뉴스 수집 후보 수", "system"), // 시장별 뉴스 후보 수 기본값을 정의한다.
                new AppSettingEntity("context.relation.codex.enabled", "{\"value\":true}", "뉴스·공시 관계 Codex 분석 활성 여부", "system"),
                ...
                new AppSettingEntity("autoresearch.maxTickers", "{\"value\":30,\"min\":1,\"max\":300}", "AutoResearch 백테스트 최대 종목 수", "system"), // AutoResearch 최대 종목 수 기본값을 정의한다.
                new AppSettingEntity("autoresearch.holdingDays", "{\"value\":20,\"min\":1,\"max\":120}", "AutoResearch 백테스트 보유 기간", "system"), // AutoResearch 보유 기간 기본값을 정의한다.
                new AppSettingEntity("autoresearch.targetPct", "{\"value\":3.0,\"min\":0.1,\"max\":50}", "AutoResearch 백테스트 목표 수익률", "system"), // AutoResearch 목표 수익률 기본값을 정의한다.
                new AppSettingEntity("autoresearch.stopPct", "{\"value\":2.0,\"min\":0.1,\"max\":50}", "AutoResearch 백테스트 손절률", "system"), // AutoResearch 손절률 기본값을 정의한다.
                ...
                new AppSettingEntity("dailybrief.prompt.maxChars", "{\"value\":6000,\"min\":800,\"max\":20000}", "Daily Brief Codex 프롬프트 최대 문자 수", "system"), // Daily Brief 프롬프트 최대 길이 기본값을 정의한다.
                ...
                new AppSettingEntity("collection.kis.dailyPrice.delayMs", "{\"value\":600,\"min\":100,\"max\":3000}", "KIS 일봉 호출 간 딜레이(ms)", "system") // KIS API 초당 한도 준수 딜레이 기본값을 정의한다.
        ); // 기본 설정 목록 생성을 종료한다.
