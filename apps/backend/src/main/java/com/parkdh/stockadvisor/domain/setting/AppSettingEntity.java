...
public class AppSettingEntity extends BaseEntity { // 앱 설정 엔티티를 정의한다.
    ...
    protected AppSettingEntity() { // JPA 기본 생성자를 정의한다.
    } // 기본 생성자를 종료한다.
    ...
    public String getSettingKey() { return settingKey; } // 설정 키를 반환한다.

    public String getValueJson() { return valueJson; } // 설정 값 JSON을 반환한다.

    public String getDescription() { return description; } // 설정 설명을 반환한다.

    public String getUpdatedBy() { return updatedBy; } // 수정자를 반환한다.
} // 앱 설정 엔티티를 종료한다.
