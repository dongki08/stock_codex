...
>
> ⚠️ **현행 정정(2026-06-02)**: 이 문서는 결함 발견/수정의 역사 기록이다. C-5/C-6/F-7/F-12/F-13/F-14/F-16 등 일부 "미해결" 표기는 당시 스냅샷 기준이며, 현행 상태 판단은 [11-ROADMAP](11-ROADMAP.md) §0 및 [40-RETURN-STRATEGY](40-RETURN-STRATEGY.md)를 우선한다. 최신 코드 기준 백엔드 테스트와 프론트 빌드는 통과했다.
>
