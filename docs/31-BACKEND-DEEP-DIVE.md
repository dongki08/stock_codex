...
> 🧭 인덱스: [00-INDEX.md](00-INDEX.md) · 카테고리 31(상세 아키텍처) · 상태 🟢 현행(2026-05-26 갱신) · 요약은 [30-BACKEND-OVERVIEW.md](30-BACKEND-OVERVIEW.md)
>
...
>
> **2026-05-26 재정리 (현 시점)**: 실제 코드 기준으로 패키지 수·테스트 수·Flyway 버전·Properties 클래스 누락분 보정. 본 문서는 현재 코드 기준으로 갱신됨.
>
> 주요 추가/변경:
...
10. [스케줄러 9종 — 자동 동작 시각표](#10-스케줄러-9종--자동-동작-시각표)
...
├── scheduler/                         // @Scheduled 7개 클래스 + 1개 헬퍼
